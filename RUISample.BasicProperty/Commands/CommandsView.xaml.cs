...
using ReactiveUI;
using RUISamples.Commands;

namespace RUISample.BasicProperty.Commands
{
	/// <summary>
	/// Interaction logic for CommandsView.xaml
	/// </summary>
	public partial class CommandsView : IViewFor<ShellViewModel>
	{
		public CommandsView()
		{
		...
		public static readonly DependencyProperty ViewModelProperty = DependencyProperty.Register(
			"ViewModel", typeof(ShellViewModel), typeof(CommandsView), new PropertyMetadata(default(ShellViewModel)));
